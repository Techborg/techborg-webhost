...
<html>
	<head>
		<meta charset="utf-8">
		<title>TechBorg - WebProgramming</title>
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-6 col-sm-6">
							...
							<div class="entry">
								<!-- blog entry image -->
								<img class="img-responsive" src="img/weblang/html.png" alt="Blog" />
								<!-- heading / blog post title -->
								<h3><a href="html.php">HTML</a></h3>
								<!-- blog information -->
								<span class="meta">
						...
						<div class="col-md-6 col-sm-6">
							...
							<div class="entry">
								<!-- blog entry image -->
								<img class="img-responsive" src="img/weblang/css.png" alt="Blog" />
								<!-- heading / blog post title -->
								<h3><a href="css.php">CSS</a></h3>
								<!-- blog information -->
								<span class="meta">
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-6 col-sm-6">
							...
							<div class="entry">
								<!-- blog entry image -->
								<img class="img-responsive" src="img/weblang/javascript.png" alt="Blog" />
								<!-- heading / blog post title -->
								<h3><a href="javascript.php">JavaScript</a></h3>
								<!-- blog information -->
								<span class="meta">
						...
						<div class="col-md-6 col-sm-6">
							...
							<div class="entry">
								<!-- blog entry image -->
								<img class="img-responsive" src="img/weblang/php.png" alt="Blog" />
								<!-- heading / blog post title -->
